...
const skills = [
  ...
  { name: "EDA", level: 70, category: "Data Science" },
  { name: "Scikit-Learn", level: 60, category: "Machine Learning" },
  { name: "Regression", level: 50, category: "Machine Learning" },
  { name: "Classification", level: 50, category: "Machine Learning" },
  ...
  // Database
  { name: "Mongo Db", level: 60, category: "Database" },
...
const categories = ["all", "frontend", "Data Science", "Machine Learning", "Programming Languages", "Database", "tools"];
