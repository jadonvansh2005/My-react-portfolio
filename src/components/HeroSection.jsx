...
export const HeroSection = () => {
  return (
    ...
    >
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between max-w-6xl z-10">
        {/* Text Content (Left) */}
        ...
        <div className="w-full md:w-1/2 mt-10 md:mt-0 flex justify-center">
          <img
            src="/projects/IMG_20250704_102818 (3).png" // 👈 Replace with your actual image path
